...
const VideoSection = ({ header, description }) => {
    const src1 = "https://prod.flowcvassets.com/landing/videos/flow-cv-resume-builder-intro-video-en1.mp4";
    const src2 = "https://prod.flowcvassets.com/landing/videos/flow-cv-resume-builder-intro-video-en2.mp4";
    const src3 = "https://prod.flowcvassets.com/landing/videos/flow-cv-resume-builder-intro-video-en3.mp4";
    return (
        <section className="pageContainer pt-4 md:pt-8 pb-12 lg:pt-28 lg:pb-28 flex flex-col justify-center items-center">
            ...
            <p className="mt-4 leading-relaxed md:text-xl text-gray-500">{description}</p>
            ...
            <div className="mt-8 md:mt-9 lg:mt-10 w-full m-w-[1200px]">
                <div className="shadow-2xl">
                    ...
                    <div className="relative w-full pt-[62.5%]">
                        <video
                            className="absolute left-0 top-0 w-full h-auto rounded"
                            autoplay=""
                            loop=""
                            playsinline=""
                            muted=""
                        ...
                        >
                            <source
                                data-src={header.toLowerCase().includes("design") ? src1 : header.toLowerCase().includes("avoid") ? src2 : src3}
                                type="video/mp4"
                                src={header.toLowerCase().includes("design") ? src1 : header.toLowerCase().includes("avoid") ? src2 : src3}
                            />
                        </video>
                    </div>
                </div>
