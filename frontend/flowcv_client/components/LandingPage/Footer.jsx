  ...
  return (
    <div className="w-[70vw] mt-32 mb-5">
      ...
      <div className="flex flex-row items-start justify-between mt-10">
        ...
        <div class="grid grid-cols-[auto_auto] md:justify-end gap-16 md:gap-24 lg:gap-40">
          <div class="flex flex-col items-start">
            <h3 class="text-pink-600 text-xl">FlowCV</h3>
            <a
              href="/about"
          ...
          <div class="flex flex-col items-start">
            <h3 class="text-pink-600 text-xl">Help</h3>
            <a
              href="/pricing"
              target="_blank"
              class="mt-3 block py-3 text-base hover:opacity-80"
            ...
            <a
              href="mailto:contact@flowcv.com"
              class="block py-3 text-base hover:opacity-80"
              target="_blank"
            >
              Contact us
      ...
      <div className="flex flex-row justify-around items-center mt-20">
        ...
        <div class="w-full md:order-2">
          <div class="flex flex-col md:-mr-3 md:flex-row md:items-center md:justify-end">
            <p class="flex items-center text-xl w-[15rem] font-extrabold md:mr-8 md:font-normal">
