...
const BottomSection = () => {
    return (
        <div className="pageContainer flex flex-col justify-center items-center mt-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-12 place-items-center place-content-center">
                {cardsData.map((c) => (
            ...
            <div className="flex flex-col items-center ml-auto mr-auto pl-[1.25rem] pr-[1.25rem] mt-20 max-w-[1250px] w-full">
