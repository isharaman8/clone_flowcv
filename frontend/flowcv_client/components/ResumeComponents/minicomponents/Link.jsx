        ...
        <div className="mb-4" style="width: 100%;">
            ...
            <div className="relative flex items-center">
                <input
                    ...
                    className="h-inputHeight w-full appearance-none rounded-medium text-base leading-normal shadow-none outline-none md:text-[17px] font-sans m-0 placeholder-inputPlaceholder bg-inputBackground border border-solid border-inputBorder text-inputText p-[10px]"
                    autocomplete="off"
                    value={value}
                    onInput={handleValue}
                />
                <div className="relative">
                    <button
                        type="button"
                        className="cursor-pointer appearance-none touch-manipulation flex items-center justify-center focus-visible:outline-blue-600 hover:opacity-80 bg-white text-uncheckedGray border-uncheckedGray border border-solid ml-1 h-inputHeight rounded-medium pl-3 pr-4"
                    >
                        <svg viewBox="0 0 17 17" xmlns="http://www.w3.org/2000/svg" className="mr-[2px] mb-[1px] h-[18px] w-[18px]">
                            <path
                ...
                <button
                    type="button"
                    className="border-none cursor-pointer appearance-none touch-manipulation flex items-center justify-center focus-visible:outline-blue-600 hover:opacity-80 bg-red-50 text-red-800 min-w-inputHeight ml-1 h-inputHeight w-inputHeight min-w-min flex-[0_0_theme(spacing.inputHeight)] rounded-medium"
                >
