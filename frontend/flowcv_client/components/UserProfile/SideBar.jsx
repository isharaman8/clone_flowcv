...
const SideBar = ({ setProfile }) => {
  ...
  const handleSubmit = (method) => {
    if (method === "change_email") {
      if (
        !changeEmail.email.trim().length ||
        !changeEmail.password.trim().length
      ) {
    ...
    if (method === "change_password") {
      if (
        !changePassword.password.trim().length ||
        !changePassword.newPassword.trim().length ||
        !changePassword.cNewPassword.trim().length
      ) {
        return alert("please enter password");
      }

      if (
        changePassword.newPassword.trim() !== changePassword.cNewPassword.trim()
      ) {
