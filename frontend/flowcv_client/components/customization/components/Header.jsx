            ...
            <div className="flex gap-3 flex-wrap">
                <DragDropContext onDragEnd={handleDragEnd}>
                    <Droppable droppableId="sections" direction="horizontal">
                        {(provided) => (
                            <div {...provided.droppableProps} ref={provided.innerRef} className="flex gap-3 flex-wrap">
                                    ...
                                    return (
                                        <Draggable key={section.id.toString()} draggableId={section.id.toString()} index={index}>
                                            {(provided) => (
                                                ...
                                                >
                                                    <h1 className="flex flex-wrap gap-3 items-center font-semibold text-sm">
        ...
        <div className="bg-white rounded-2xl w-full pt-6 pb-9 px-5 md:px-7 lg:px-9 relative max-w-full mt-4">
            ...
            <div className="w-[19rem] sm:w-[30rem]">
                ...
                <div className="flex gap-2">
                    <div
                        className={`py-2 px-[1.4rem] sm:px-[3.4rem] text-sm border  ${
