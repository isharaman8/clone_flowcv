        ...
        <div class="mt-10 lg:mt-12">
          ...
          <div class="mt-6 sm:mt-12 md:mt-16">
            <label>
              <input
                type="checkbox"
                name="productUpdateNotifications"
                class="fixed h-[1px] w-[1px] opacity-0"
                value=""
              />
              <div class="flex cursor-pointer items-center hover:opacity-80">
                ...
                <span class="ml-1 text-base font-semibold">
                  Get FlowCV updates. No spam ever.
                </span>
              </div>
            </label>
          </div>
          ...
          <div class="mt-12 flex justify-center">
            <p class="whitespace-pre-line  text-justify align-middle text-sm text-gray-600">
              ...
              . We do not sell your personal data. To learn more about how we
              collect, use, share and protect it please read our{" "}
              <a
