        ...
        <>
            ...
            <section>
                        ...
                        <div className="mt-12">
                            ...
                            <div className="flex justify-center mt-8 lg:justify-start lg:mt-12">
                                <div className="flex flex-col items-center">
                                    ...
                                    <p className="max-w-full mt-5 text-center lg:text-left text-[.9rem]">No account needed.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <VideoSection
                    ...
                    description={"Format your resume with just a few clicks and reformat it easily."}
                />
                <TemplatesSection />
                <VideoSection header={"Avoid common pitfalls"} description={"Get guidance on what goes inside a job-winning resume."} />
                <Testimonials />
                <VideoSection header={"Quick, easy & flexible"} description={"Effortless editing with live preview."} />
                <BottomSection />
            </section>
            <Footer />
        </>
